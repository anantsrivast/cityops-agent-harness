...
AGENT_LOOP = [
    ...
    code(
        ...
        "    \"Completion: the reading tools (search, recent findings, asset lookup) are\\n\"\n"
        "    \"preparation, not the deliverable. If the task asks you to record or log a finding,\\n\"\n"
        "    \"you are NOT done until you have called tool_log_finding and received a finding_id -\\n\"\n"
        "    \"never end your turn with only reads. If the task is purely a lookup, record nothing.\\n\"\n"
...
JUDGE = [
    ...
    code(
        ...
        "    \"  (b) every finding_id cited in the final answer appears in the evidence as EXISTS;\\n\"\n"
        "    \"  (c) the final answer does not contradict the trajectory or invent database records.\\n\"\n"
